...
VALUES
(1, 'Azúcar Refinada', 'Kg', 'L1234', 1000 , '2025-12-31', 20),
(2, 'Cacao en Polvo', 'Kg', 'L5678', 500 , '2024-11-15', 45),
(3, 'Glucosa Líquida', 'L', 'L2345', 800 , '2025-06-01', 30),
(4, 'Gelatina sin Sabor', 'Kg', 'L3456', 600 , '2024-09-10', 25),
(5, 'Colorante Rojo', 'Kg', 'L4567', 200 , '2026-03-22', 15),
(6, 'Esencia de Vainilla', 'L', 'L6789', 100, '2024-12-05', 50),
(7, 'Sorbitol', 'Kg', 'L7890', 300, '2025-02-14', 35);

INSERT INTO compras (id_proveedor, id_mp, fecha_compra, lote, cantidad, precio, descuento)
VALUES
(1, 1, '2024-01-15', 'L1234', 500 , 10000, 5.0),  
(2, 2, '2024-02-01', 'L5678', 200 , 9000, 0.0),   
(3, 3, '2024-02-10', 'L2345', 300 , 7500, 2.5),    
(4, 4, '2024-03-05', 'L3456', 400 , 10000, 3.0),  
(5, 5, '2024-03-20', 'L4567', 100 , 3000, 1.5),    
(6, 6, '2024-04-12', 'L6789', 50 , 2500, 0.0),    
(7, 7, '2024-04-25', 'L7890', 150 , 5250, 4.0),   -- Compra de Sorbitol a Emulsificantes y Conservantes S.A.
(1, 1, '2024-05-10', 'L1235', 700 , 14000, 6.0),  -- Otra compra de Azúcar Refinada a Azúcar Fina S.A.
(2, 2, '2024-05-20', 'L5679', 250 , 11250, 1.0),  -- Otra compra de Cacao en Polvo a Cacao Natural S.R.L.
(3, 3, '2024-06-01', 'L2346', 400 , 10000, 2.0),   -- Otra compra de Glucosa Líquida a Frutas Tropicales S.A.
(4, 4, '2024-06-15', 'L3457', 300 , 7500, 3.5),   -- Otra compra de Gelatina sin Sabor a Colorantes y Sabores S.A.
(5, 5, '2024-07-05', 'L4568', 120 , 3600, 2.0),    -- Otra compra de Colorante Rojo a Gelatina y Maíz S.R.L.
(6, 6, '2024-07-20', 'L6790', 60 , 3000, 0.0),     -- Otra compra de Esencia de Vainilla a Esencias y Aromas Ltda.
(7, 7, '2024-08-10', 'L7891', 200 , 7000, 5.0),   -- Otra compra de Sorbitol a Emulsificantes y Conservantes S.A.
(1, 1, '2024-09-01', 'L1236', 800 , 16000, 7.0),  -- Más Azúcar Refinada a Azúcar Fina S.A.
(2, 2, '2024-09-15', 'L5680', 300 , 13500, 2.0),  -- Más Cacao en Polvo a Cacao Natural S.R.L.
(3, 3, '2024-10-01', 'L2347', 450 , 11250, 2.5),   -- Más Glucosa Líquida a Frutas Tropicales S.A.
(4, 4, '2024-10-20', 'L3458', 350 , 8750, 4.0),   -- Más Gelatina sin Sabor a Colorantes y Sabores S.A.
(5, 5, '2024-11-05', 'L4569', 150 , 4500, 3.0),    -- Más Colorante Rojo a Gelatina y Maíz S.R.L.
(6, 6, '2024-11-20', 'L6791', 80 , 4000, 0.0);     -- Más Esencia de Vainilla a Esencias y Aromas Ltda.
