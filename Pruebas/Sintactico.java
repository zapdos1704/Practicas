...
public class Sintactico {
    ...
    private static final String[] NO_TERMINALES = {
        "P", "D", "D'", "S", "S'", "I", "L", "L'", "E", "EL", "EL'", "ER", "ER'", "T", "T'", "F", "TIPO", "A","EXPR","MULT","MULT'"
    };
    ...
    private static final String[][] TABLA_SINTACTICA = {
    	    ...
    	    /*D    */{  "SALTAR",                "SALTAR",          "SALTAR",       "SALTAR",        "SALTAR",    "SALTAR",       "SALTAR",       "SALTAR",      "SALTAR", 		"SALTAR", 		"SALTAR",        "SALTAR", 		 "SALTAR",   	 "SALTAR", 		 "SALTAR", 		 "SALTAR", 		  "SALTAR", 	"SALTAR", 		 "SALTAR", 		 "SALTAR", 		 "SALTAR", 		 "SALTAR", 		"SALTAR", 		"SALTAR", 		"SALTAR", 		 "SALTAR", 			"SALTAR", 					  "SACAR", 		   "SALTAR", 				  "SALTAR", 	  "SALTAR", 				"SALTAR", 	 "SACAR", 		      "SALTAR", 	  "SALTAR", 	   "SALTAR", 							"SALTAR", 	   "SALTAR", 		  "SALTAR", 	   "TIPO ID MULT ; D'", 	 "TIPO ID = E ; D'",   "TIPO ID = E ; D'", 	   "TIPO ID = E ; D'", 		"TIPO ID = E ; D'", "TIPO ID = E ; D'", 	"SACAR"},
    	    ...
    	    /*S    */{ "ID A ; S'",             "SALTAR",          "SALTAR",       "SALTAR",        "SALTAR",    "SALTAR",       "SALTAR",       "SALTAR",      "SALTAR", 		"SALTAR", 		"SALTAR",        "SALTAR", 		 "SALTAR",   	 "SALTAR", 		 "SALTAR", 		 "SALTAR", 		  "SALTAR", 	"SALTAR", 		 "SALTAR", 		 "SALTAR", 		 "{ S } S'", 	 "SALTAR", 		"SACAR", 		"SALTAR", 		"SALTAR", 		 "SALTAR", 			"SALTAR", 					  "SACAR", 		   "for ID : ER I endFor S'",  "SALTAR", 	  "while EXPR I endWhile S'", "SALTAR",  "if EXPR I endif S'",   "SALTAR", 	  "SALTAR", 	   "method ID L S endMethod S'", 	    "e", 	   	   "return E ; S'",   "SALTAR", 	   "TIPO ID MULT ; S'", 	         "SALTAR",   		   "SALTAR", 			   "SALTAR", 				"SALTAR", 			"SALTAR", 				"SACAR"},

    	    /*S'   */{"ID A ; S'",              "SALTAR",          "SALTAR",       "SALTAR",        "SALTAR",    "SALTAR",       "SALTAR",       "SALTAR",      "SALTAR", 		"SALTAR", 		"SALTAR",        "SALTAR", 		 "SALTAR",   	 "SALTAR", 		 "SALTAR", 		 "SALTAR", 		  "SALTAR", 	"SALTAR", 		 "SALTAR", 		 "SALTAR", 		 "{ S } S'", 	 "SACAR", 		"e", 	 		"SALTAR", 		"SALTAR", 		 "SALTAR", 			"SALTAR", 					  "e", 		   	   "for ID : ER I endFor S'",  "e", 	  	  "while EXPR I endWhile S'",  "e",	     "if EXPR I endif S'",   "e", 	  	  "SALTAR", 	   "method ID L S endMethod S'", 	    "e", 	       "return E ; S'",   "SALTAR", 	   "TIPO ID MULT ; S'", 	 		 "SALTAR",   		   "SALTAR", 			   "SALTAR", 				"SALTAR", 			"SALTAR", 				"SALTAR"},
    	       
    	    /*I    */{"ID A ;",                 "SALTAR",          "SALTAR",       "SALTAR",        "SALTAR",    "SALTAR",       "SALTAR",       "SALTAR",      "SALTAR", 		"SALTAR", 		"SALTAR",        "SALTAR", 		 "SALTAR",   	 "SALTAR", 		 "SALTAR", 		 "SALTAR", 		  "SALTAR", 	"SALTAR", 		 "SALTAR", 		 "SALTAR", 		 "{ S }", 		 "SACAR", 		"SALTAR", 		"SALTAR", 		"SALTAR", 		 "SALTAR", 			"SALTAR", 					  "SALTAR", 	   "for ID : ER I endFor",     "SALTAR", 	  "while EXPR I endWhile", 	"SALTAR", 	 "if EXPR I endif",      "e", 	  	  "SALTAR", 	   "method ID L S endMethod", 		    "SALTAR", 	   "return E ;", 	  "SALTAR", 	   "TIPO ID MULT ; ", 	 		 "SALTAR",   		   "SALTAR", 			   "SALTAR", 				"SALTAR", 			"SALTAR", 				"SALTAR"},
    	    ...
    	    /*MULT*/ {"SALTAR",                "SALTAR",          "SALTAR",       "SALTAR",        "SALTAR",    "SALTAR",       "SALTAR",       "SALTAR",      "SALTAR", 		"SALTAR", 		"SALTAR",        "SALTAR", 		 "SALTAR",   	 "SALTAR", 		 "SALTAR", 		 "SALTAR", 		  "SALTAR", 	"SALTAR", 		 "= E", 		 "SALTAR", 		 "SALTAR", 		 "SALTAR", 		"SALTAR", 		"e", 			"ID MULT", 		 "SALTAR", 			"SALTAR", 					  "SACAR", 		   "SALTAR", 				  "SALTAR", 	  "SALTAR", 				"SALTAR", 	 "SACAR", 		      "SALTAR", 	  "SALTAR", 	   "SALTAR", 							"SALTAR", 	   "SALTAR", 		  "SALTAR", 	   "SALTAR", 	 		 "SALTAR",   		   "SALTAR", 	   		   "SALTAR", 		        "SALTAR", 			"SALTAR", 				"SACAR"}
